...
Usage:
    python short_term_scanner.py                              # scan tickers.txt
    python short_term_scanner.py MRVL AAPL CRDO
    python short_term_scanner.py --catalysts catalysts.json --top 20 --leverage 5
"""
